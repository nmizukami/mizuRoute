MODULE globalData
  ...
  type(io_desc_t),                 public :: ioDesc_hru_float                   ! [hru] (single precision)
  type(io_desc_t),                 public :: ioDesc_rch_float                   ! [reach] (single precision)
  type(io_desc_t),                 public :: ioDesc_gauge_float                 ! [gauge points] (single precision)
