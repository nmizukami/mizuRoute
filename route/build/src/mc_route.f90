...
CONTAINS
 ...
 if (RCHFLX_out(segIndex)%ROUTE(idxMC)%REACH_VOL(1) < 0) then
 ...
 call comp_reach_wb(NETOPO_in(segIndex)%REACHID, idxMC, q_upstream, RCHFLX_out(segIndex), verbose, lakeFlag=.false.)
